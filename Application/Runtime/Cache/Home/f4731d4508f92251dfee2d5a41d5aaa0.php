...
<head>
    ...
    <style>
        ...
        .content_info>span:last-of-type{
            border-right: none;
        }
        .content_info>span>img{
            height: 14px;
            width: 14px;
            margin: 0 5px;
            cursor: pointer;
...
<div class="wrap"><!-- 外层包裹层 begin -->
        ...
        <ul id="ul_content">
            ...
            <li class="content_wrap_box">
                <div class="content_info">
                    ...
                    <h3>这是标题</h3>
                    <span>用户名 <img src="img/add.jpg" alt=""></span>
                    <span>文章类型</span>
                    <span>创作方式</span>
                    <span>完结</span>
    ...
    <div class="content_right"><!-- content_right  begin--最右边内容-->
        ...
        <!-- 用户登录后展示-->
        <img class="logo" src="/Public/img/advertise.jpg">
...
<script type="text/javascript">
    //当鼠标悬停在该盒子上时改变样式
      ...
      var ul_content = document.getElementsByClassName('ul_content');
      var a_content = ul_content.getElementsByTagName('a');
     alert(a_content.length);
      var  li_content = ul_content.getElementsByTagName('li');
    alert('11');
      alert(li_content.length);

    content_wrap_box.onmouseover = function(){
          this.style.boxShadow = '2px 1px 5px 0px green';
      }
    //当鼠标离开该盒子时回复之前的样式
    content_wrap_box.onmouseout = function(){
        this.style.boxShadow = '2px 1px 5px 0px gray';
    }
    /*$('.content_wrap_box').mouseover(function(){
        $('.content_wrap_box').css(
            'boxShadow', '2px 1px 5px 0px green'
        );
    });

    //当鼠标离开该盒子时回复之前的样式
    $('.content_wrap_box').mouseout(function(){
        $('.content_wrap_box').css('boxShadow','2px 1px 2px 0px gray');
    });*/
</script>
</body>
</html>